      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            ...
            <img
            src="/images/garanti.png" width="100">
            <!-- Garanti Online -->
            <span class="text-primary">.</span> </a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="/login" class="nav-link">Account Login</a></li>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-0">
              ...
              <a href="#">info@alliancemicrofinancebank-org.cf</a>
            </p>
          </div>
        </div>
        <div class="row">
...
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="fafaba15-e213-49c2-95c6-5fe9773680fa";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
